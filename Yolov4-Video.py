...
file_video_stream = cv2.VideoCapture('E:/ARTIFICIAL INTELIGENCE/Class/Object Detector,Image Segmentation,Model optimisation and Inference/video (1).mp4')
...
while True:
    ...
    yolo_model = cv2.dnn.readNetFromDarknet('E:/ARTIFICIAL INTELIGENCE/Assignment/Object Detector,Image Segmentation,Model optimisation and Inference/yolov4.cfg','E:/ARTIFICIAL INTELIGENCE/Assignment/Object Detector,Image Segmentation,Model optimisation and Inference/yolov4.weights')
